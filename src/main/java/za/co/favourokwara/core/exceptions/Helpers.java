 ...
 * {@link za.co.favourokwara.core.exceptions} package.
 */
public interface Helpers {
     ...
     * 
     * @param name       the name if the not found record.
     * @param parameters query parameters key-value pairs.
     * @return a message stating that the record not found.
     * @implNote example output could be like this: Record not found for parameters
     *           (id:'1').
     */
    @SafeVarargs
