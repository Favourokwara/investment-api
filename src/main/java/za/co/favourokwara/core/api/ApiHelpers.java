...
public interface ApiHelpers {
    ...
    /**
     * Create a {@link URI} from {@literal info}.
     * 
     * @param info either the value returned from a "mock" controller invocation or
     *             the "mock" controller itself after an invocation.
     * @return a {@link URI}.
